...
<head>
    ...
    <link href="../Funcionario/CSS/gerenciamento_usuario.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <main class="Main">
        ...
        <div class="Main_Cont2">
           <!-- Adicionar Chave -->
           <div class="botao chave" id="botao-cadastro1"><h3>Cadastro de de usuários</h3></div>
            <div class="form1_cad_Chaves" id="formChave">
                <div id="botao-cadastro2"><h3>Cadastro de usuários</h3></div>
                
                <form id="CadastroChaves" action="../Funcionario/PHP/GERENCIAMENTO/Chave.php"
                 method="POST">
                    <div style="display: none"></div>
                    <div>
                        <label for="idChave">Nome do Usuário: </label>
                        <input type="text" name="idChave" id="idChave">
                    </div>
                    <div>
                        <label for="idPredio">Número de matrícula: </label>
                        <input type="number" name="idPredio" id="idPredio">
                    </div>
                    <div>
                        <label for="idChave">Descrição do usuário: </label>
                        <select id="DescriChave" name="DescriChave">
                            <option value="Sala">Professor</option>
                            <option value="Lab">Servidor</option>
                            <option value="Auditório">Administrador</option>
                            <option value="Ginásio">Estudante</option>
                            <option value="Banheiro">Terceirizado</option>
